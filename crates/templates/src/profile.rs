use anyhow::Result;
use generust_example_project_core::profile::Theme;
...
fn nav_swatch(p: &generust_example_project_core::profile::UserProfile, c: &str) -> Markup {
...
fn link_swatch(p: &generust_example_project_core::profile::UserProfile, c: &str) -> Markup {
